...
export default function ImageSlide() {
    ...
    imageList.forEach((d, i) => {
        imageBox[i] = <div className="opacity-70 hover:opacity-100 flex p-1 lg:p-2 cursor-pointer hover:scale-110 focus:scale-110 transition-all" ><img onClick={imageTarget} className="rounded-lg shadow-lg shadow-black" src={d.url} alt={d.alt} id={d.index}></img></div>
    })
